...
_msg_vga_init:                               ; 0xc4780 LB 0x2e
    db  'Oracle VM VirtualBox Version 7.0.8 VGA BIOS', 00dh, 00ah, 000h
...
_vbebios_product_revision:                   ; 0xc7e55 LB 0x23
    db  'Oracle VM VirtualBox Version 7.0.8', 000h
...
section CONST2 progbits vstart=0x7ecc align=1 ; size=0x0 class=DATA group=DGROUP
  ...
  ; Padding 0x134 bytes at 0xc7ecc
    ...
    db  037h, 02eh, 030h, 02fh, 06fh, 075h, 074h, 02fh, 06ch, 069h, 06eh, 075h, 078h, 02eh, 061h, 06dh
